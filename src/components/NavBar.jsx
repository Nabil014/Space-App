  ...
  return (
    <nav>
      <header className="relative md:pt-6 z-40 items-center top-0  text-white flex justify-around lg:grid lg:grid-cols-2 gap-2">
        <div className="flex ">
          <img src="/public/logo.svg" alt="logo" className="md:px-11 " />
        ...
        <img src='/public/icon-hamburger.svg' className="md:hidden z-40 cursor-pointer" onClick={() => setShowNavbar(!showNavbar)} alt="icon-hamburger" />
      </header>
    </nav>
  )
}
